...
export default async function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-background">
      {/* Sidebar */}
      <aside className="w-64 border-r bg-slate-50/50 dark:bg-slate-900/50 p-6 flex flex-col gap-8">
        ...
        <div className="w-full">
          <OrganizationSwitcher 
            ...
            appearance={{ 
              elements: { 
                rootBox: "w-full",
                organizationSwitcherTrigger: "w-full justify-start px-3 py-2 border rounded-md hover:bg-accent",
                organizationSwitcherTriggerIcon: "text-foreground",
                organizationPreview: "px-3 py-2",
                organizationPreviewText: "text-sm font-medium",
